...
WebUI.setText(findTestObject('CURA_HS_All_Buttons_OR/Page_CURA Healthcare Service/input_Password_password'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('CURA_HS_All_Buttons_OR/Page_CURA Healthcare Service/button_Login'))

WebUI.verifyElementPresent(findTestObject('Object Repository/CURAHS_Login_Manual_Mode_OR/Page_CURA Healthcare Service/h2_Make Appointment'), 
    0)
...
WebUI.setText(findTestObject('CURA_HS_All_Buttons_OR/Page_CURA Healthcare Service/textarea_Comment_comment'), 'HI Doctor')
