...
//
WebUI.selectOptionByValue(findTestObject('Object Repository/CURAHealthcareService_MAKEAppointment_OR_002/Page_CURA Healthcare Service/Facility'), 
...
WebUI.setText(findTestObject('CURA_HS_All_Buttons_OR/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Hello Doctor')

WebUI.click(findTestObject('Object Repository/CURAHealthcareService_MAKEAppointment_OR_002/Page_CURA Healthcare Service/button_Book Appointment'))
//
//WebUI.delay(2)
//
//WebUI.closeBrowser()
